...
kg/auth/2.0.1/plugin/msgs/msg
kg/auth/2.0.1/plugin/msgs/index

*/
KISSY.add('kg/auth/2.0.1/plugin/msgs/msg',function (S, Base,Node,XTemplate) {
    var $ = Node.all;
 ...
 *
 * */
KISSY.add('kg/auth/2.0.1/plugin/msgs/index',function(S, Node, Base,Msg) {
    //消息集合
    return Base.extend({
