...
gallery/auth/1.6.1/plugin/msgs/msg
gallery/auth/1.6.1/plugin/msgs/index

*/
KISSY.add('gallery/auth/1.6.1/plugin/msgs/msg',function (S, Base,Node,XTemplate) {
    var $ = Node.all;
 ...
 *
 * */
KISSY.add('gallery/auth/1.6.1/plugin/msgs/index',function(S, Node, Base,Msg) {
    //消息集合
    return Base.extend({
