...
gallery/auth/1.6.1/lib/rule/rule
gallery/auth/1.6.1/lib/rule/default
gallery/auth/1.6.1/lib/rule/ruleFactory
gallery/auth/1.6.1/lib/utils
gallery/auth/1.6.1/lib/field/field
gallery/auth/1.6.1/index
 ...
 *
 */
KISSY.add('gallery/auth/1.6.1/lib/rule/rule',function(S, Base,Promise) {
 ...
 *
 */
KISSY.add('gallery/auth/1.6.1/lib/rule/default',function (S) {
    var EMPTY = "";
    return {
        /**
         * 是否存在值
 ...
 *
 */
KISSY.add('gallery/auth/1.6.1/lib/rule/ruleFactory',function (S, Node,Base, Rule, defaultRules) {
 ...
 *
 */
KISSY.add('gallery/auth/1.6.1/lib/utils',function (S, DOM, undefined) {
    var Utils = {
        toJSON:function (cfg) {
            cfg = cfg.replace(/'/g, '"');
            try {
 ...
 *
 */
KISSY.add('gallery/auth/1.6.1/lib/field/field',function (S, Event, Base, DOM,Node,Promise, Factory, Rule, Utils) {
    var $ = Node.all;
    var EMPTY = '';
 ...
 *
 */
KISSY.add('gallery/auth/1.6.1/index',function (S, Node,JSON, Base,Promise, Field, Factory, Utils) {
    var $ = Node.all;
    var DATA_FIELD = 'data-field';
    /**
     * @name Auth
