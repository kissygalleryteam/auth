...
<ul>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/simple_form.html">一个简单表单的验证</a></li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/add_custom_rule.html">添加自定义验证规则</a></li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/event.html">事件举例</a>(1.5+)</li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/exclude.html">exclude（可以排除验证规则）用法举例</a>(1.5+)</li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/asyn_test.html">支持异步校验！</a>(1.5+)</li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/uploader.html">与异步文件上传组件配合校验！</a>(1.5+)</li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/rule_msg.html">规则可以设置默认消息</a>(1.5+)</li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/add_field.html">可以动态添加校验字段</a>(1.6.1+)</li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/server_msg.html">配合服务器输出的消息</a>(1.5+)</li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/msg.html">字段上消息的控制</a></li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/rule_msg.html">给规则设置默认消息</a>(1.5+)</li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/noSubmitTest.html">表单提交不默认触发验证</a>(1.5+)</li>
    <li><a href="http://gallery.kissyui.com/auth/1.6.1/demo/rule_msg.html">配合butterfly使用</a>(1.5+)</li>
</ul>
...
*gallery/auth/1.6.1/plugin/msgs/*：消息插件，v1.6.1新增，*auth.plug(new AuthMsgs());*

*gallery/auth/1.6.1/plugin/msgs/style.css* ：为消息层样式。

当提交表单前默认会触发验证，验证成功提交表单，想要去掉这个作用，请配置*submitTest:false* 。

v1.6.1新增fnFilter配置，用于过滤不需要实例化的字段：
...
v1.6.1新增fnConfig配置，用于控制Field的配置：
...
请看demo：<a href="http://gallery.kissyui.com/auth/1.6.1/demo/msg.html" target="_blank">字段上消息的控制</a>。
...
请看demo：<a href="http://gallery.kissyui.com/auth/1.6.1/demo/server_msg.html" target="_blank">配合服务器输出的消息</a>。
...
[demo传送门](http://gallery.kissyui.com/auth/1.6.1/demo/add_custom_rule.html)
...
[demo传送门](http://gallery.kissyui.com/auth/1.6.1/demo/asyn_test.html)
...
[demo传送门](http://gallery.kissyui.com/auth/1.6.1/demo/event.html)
...
如果你的表单包含有[uploader]()异步上传组件，[demo传送门](http://gallery.kissyui.com/auth/1.6.1/demo/rule_msg.html)。
